...
sys.path.insert(0, os.path.abspath("../pynenc_rustvello"))

DISTRIBUTION_METADATA = importlib.metadata.metadata("pynenc-rustvello")

# -- Project information -----------------------------------------------------
author = "Luis Diaz"
project = "pynenc-rustvello"
...
autodoc2_packages = [{"path": "../pynenc_rustvello"}]
...
html_theme_options: dict[str, Any] = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pynenc/pynenc_rustvello",
            "html": """
    ...
    "source_repository": "https://github.com/pynenc/pynenc_rustvello/",
    "source_branch": "main",
